...
Adapted from https://github.com/restatedev/examples/tree/main/go/integrations/knative-go
...
```shell
helm upgrade --install restate oci://ghcr.io/restatedev/restate-helm --namespace restate --create-namespace
```
...
Now, you can register `signup` to Restate using:
